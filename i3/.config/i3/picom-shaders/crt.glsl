...
uniform float sc_freq = 0.1; // Frequency for the scanlines

uniform float sc_intensity = 0.1; // Intensity of the scanline effect
...
uniform float curvature = 0.01; // How much the window should "curve" 
